...
public class Tracker6 extends JFrame {
	...
	public Tracker6() {
		...
		JLabel lblStaticLunges = new JLabel("Dumbbell Scaption");
		lblStaticLunges.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
		lblStaticLunges.setBounds(307, 113, 185, 32);
		...
		separator_2.setBounds(307, 146, 185, 8);
		...
		JLabel lblPlankWraps = new JLabel("Side Plank w/ Dumbell");
		lblPlankWraps.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
		lblPlankWraps.setBounds(307, 220, 216, 32);
		...
		separator_7.setBounds(307, 253, 216, 8);
		...
		JLabel lblBurpees = new JLabel("Dumbell Swing");
		lblBurpees.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
		lblBurpees.setBounds(307, 332, 164, 32);
		...
		separator_8.setBounds(307, 365, 141, 8);
		...
		JLabel lblPushUps = new JLabel("Step-Up");
		...
		JLabel lblDiamondPushUps = new JLabel("Bent-Over Row");
		...
		separator_11.setBounds(307, 584, 150, 8);
		...
		JLabel lblPlank = new JLabel("Bench Press");
		lblPlank.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
		lblPlank.setBounds(307, 660, 138, 32);
